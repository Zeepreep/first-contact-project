...
class StateHandler
{
    ...
    void handleMousePressed()  { if ( currentState != null ) { currentState.handleMousePressed();  loop(); } }
    void handleMouseClicked()  { if ( currentState != null ) { currentState.handleMouseClicked();  loop(); } }
    void handleMouseReleased() { if ( currentState != null ) { currentState.handleMouseReleased(); loop(); } }
    void handleMouseDragged()  { if ( currentState != null ) { currentState.handleMouseDragged();  loop(); } }
    void handleMouseMoved()    { if ( currentState != null ) { currentState.handleMouseMoved();    loop(); } }

    void handleMouseWheel(MouseEvent event) { currentState.handleMouseWheel( event ); loop(); }


    void handleKeyTyped()    { if ( currentState != null ) { currentState.handleKeyTyped();    loop(); } }
    void handleKeyPressed()  { if ( currentState != null ) { currentState.handleKeyPressed();  loop(); } }
    void handleKeyReleased() { if ( currentState != null ) { currentState.handleKeyReleased(); loop(); } }
